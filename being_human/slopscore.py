...
# Ships inside the package. The repo-root fallback keeps a source checkout
# working if the data directory is ever kept outside the package again.
DEFAULT_LEXICON = os.path.join(HERE, "data", "slop-lexicon.json")
if not os.path.exists(DEFAULT_LEXICON):
    DEFAULT_LEXICON = os.path.join(HERE, "..", "data", "slop-lexicon.json")
